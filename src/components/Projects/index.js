        ...
        <div className="projects-wrap">
          ...
          <div className="project-list">
            <div className="project-card">
              <img src="/ecom-dashboard.png" alt="" className="project-image" />
              <div>
                <div className="project-heading">
                  <h5 className="p-title">Ecom Dashboard</h5>
                  <a
                    className="visit"
            ...
            <div className="project-card">
              <img
                src="/foamhead-storefront.png"
                alt=""
                className="project-image"
              />
              <div>
                <div className="project-heading">
                  <h5 class="p-title">Ecom Storefront</h5>
                  <a
                    className="visit"
            ...
            <div className="project-card">
              <img
                src="/ecom-backend-api.png"
                alt=""
                className="project-image"
              />
              <div>
                <div className="project-heading">
                  <h5 class="p-title">Ecom Backend REST API</h5>
                  <a
                ...
                <p class="p-desc">
                  Backend API for a storefront and dashboard ecom applications
